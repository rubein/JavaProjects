...
<link href="jsps/ddmenu.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="ddmenu.css">
<script type="text/javascript" src="jsps/ddmenu.js"></script>
...
body {
	background: #eee url(jsps/rr.jpg) no-repeat center 0px;
	padding-top: 90px;
}
</style>
</head>
<body>
	...
	<nav id="ddmenu">
		...
		<ul>
			<li class="full-width"><span class="top-heading"><a
					href="jsps/home.jsp">Home</a></span>
			<li class="no-sub"><a class="top-heading" href="jsps/about-us.jsp">About
				...
				<div class="dropdown">
					<div class="dd-inner">
						...
						<ul class="column mayHide">
							<li><br /> <img src="jsps/rr.png" /></li>
						</ul>
					</div>
				</div></li>
			</li>

			<li><a class="top-heading" href="jsps/contact.jsp">Contact Us</a> <i
				class="caret"></i>
				<div class="dropdown">
					<div class="dd-inner">
						<ul class="column">
						...
						<ul class="column mayHide">
							<li><br /> <img src="jsps/tt.png" /></li>
						</ul>
					</div>
				</div></li>
			<li><a class="top-heading" href="jsps/drugs.jsp">Drugs</a> <i class="caret"></i>
                ...
                <div class="dd-inner">
                    ...
                    <ul class="column mayHide">
                        <li><br /><img src="jsps/df.jpg" /></li>
                    </ul>
                </div>
            </div></li>
			<li class="no-sub"><a class="top-heading" href="jsps/adminLogin.jsp">Login</a>
			</li>
	...
	<div id="panel">
		<div class="form-style-5">
			...
			<%@ page import="com.drugTodrug.servlets.UploadExcelFile"%>
			<%@ page import="com.drugTodrug.servlets.FrontController"%>
			<%@ page import="com.drugTodrug.dao.BaseDao"%>
