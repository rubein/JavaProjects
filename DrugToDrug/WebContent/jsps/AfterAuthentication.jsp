...
@media (max-width: 550px) {
    ...
    body { background: #eee url(cv.jpg) no-repeat center 0px; padding-top:90px;}
    </style>
</head>
<body>
<nav id="ddmenu">
...
<h5 align="right"><a href="logout.do" >Logout</a></h5>
...
<form onsubmit="return Validate(this);" action="uploadExcelFile.do"
		...
		<table align="center">
			...
			<tr>
				<td><input type="submit" value="Add To Database" align="center"></td>
			</tr>
		</table>
	</form>
