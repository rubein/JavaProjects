...
public class ResultsetToExcel {
	...
	private FormatType[] formatTypes = new FormatType[20];
	...
	public FormatType getFormatType(Class _class) {
	...
	public void generate(OutputStream outputStream) throws Exception {
		...
		System.out.println("entered generate main code");
		try {
...
//					formatTypes[i] = getFormatType(_class);
	...
	private void writeCell(HSSFRow row, int col, Object value, FormatType formatType,
		...
		if (bgColor != null) {
			...
			CellUtil.setCellStyleProperty(cell, workbook, CellUtil.FILL_PATTERN,
